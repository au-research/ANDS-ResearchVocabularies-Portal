...
<?php if($oauth_conf['providers']['Twitter']['enabled']): ?>
  <a role="button" href="<?php echo portal_auth_url('auth/authenticate/twitter'); ?>?redirect=<?php echo $this->input->get('redirect') ?>" class="btn btn-primary btn-block btn-icon-left">Login with Twitter <span><i class="fa fa-twitter"></i></span></a>
<?php endif; ?>

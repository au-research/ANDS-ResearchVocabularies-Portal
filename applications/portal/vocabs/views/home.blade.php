...
<section class="section swatch-dark-blue search-section
    ...
    <div class="container element-tall-top element-normal-bottom">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action=""
                      ng-submit="$event.preventDefault();search()"
                ...
                <div class="pull-right">
                    <a href="{{ portal_url('search') }}">Browse all
                        vocabularies</a>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <header class="animated fadeIn">
                    ...
                    <p class="big hairline">
                        helps you find, access, and reuse vocabularies
                        for research.
                    </p>
                </header>
            </div>
    ...
    <div class="container">
        <div id="services" class="row">
            <div class="col-md-12">
                ...
                <div class="row" data-os-animation=""
                        ...
                        <a href="{{ portal_url('vocabs/page/contribute') }}">
                            <div class="element-medium-top
                                ...
                                <h3 class="normal bold bordered
                                           bordered-small">Publish a
                                    vocabulary</h3>
                                <p class="">Upload, describe and publish
                                    your vocabularies to Research Vocabularies
                                    Australia</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="{{ portal_url('vocabs/page/use') }}">
                            <div class="element-medium-top
                                ...
                                <p class="">Understand how you can utilise
                        ...
                        <a href="{{ portal_url('vocabs/page/widget_explorer') }}">
                            <div class="element-medium-top
                                ...
                                <h3 class="normal bold bordered
                                    ...
                                    vocabularies</h3>
                                <p class="">Discover vocabularies that can
                                    be readily used in your system using
                                    our vocabulary widget</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="{{ portal_url('vocabs/page/feedback') }}">
                            <div class="element-medium-top
                                ...
                                <p class="">Help Research Vocabularies
                                    Australia to grow into a comprehensive
                                    vocabulary portal</p>
                            </div>
                        </a>
                    </div>
